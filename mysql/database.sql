...
CREATE TABLE `emails_opt_log`  (
  ...
  `time` datetime(6) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 147816 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
CREATE TABLE `freestyle_player_everyday_award_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `ID_UNIQUE`(`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7518 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '比赛场次日志表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `freestyle_player_everyweek_award_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `ID_UNIQUE`(`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '比赛场次日志表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `freestyle_race_player_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `ID_UNIQUE`(`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 45939 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '玩家比赛日志表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `match_nor_player_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `ID_UNIQUE`(`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 19514 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '玩家比赛日志表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `nor_ddz_nor_race_player_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `ID_UNIQUE`(`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 73243 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
CREATE TABLE `nor_mj_xzdd_race_player_log`  (
  ...
  `pai_info` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT '0',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 29435 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 723650 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '玩家财物日志表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 715396 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'player_asset_log 表中 的退款记录' ROW_FORMAT = Dynamic;
...
CREATE TABLE `player_dress_info_log`  (
  ...
  `log_time` datetime(0) NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1359 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
CREATE TABLE `player_ji_pai_qi_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `ID_UNIQUE`(`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9538 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '玩家财物表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `player_login_log`  (
  ...
  INDEX `id`(`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 225964 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '登录日志表\r\n' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 491 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '玩家道具日志表' ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for sczd_gjhhr_day_achievements
-- ----------------------------
DROP TABLE IF EXISTS `sczd_gjhhr_day_achievements`;
CREATE TABLE `sczd_gjhhr_day_achievements`  (
  `id` int(11) NULL DEFAULT NULL,
  `gjhhr_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `achievements` bigint(20) NULL DEFAULT NULL,
  `time` datetime(0) NULL DEFAULT NULL
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for sczd_gjhhr_day_achievements_log
-- ----------------------------
DROP TABLE IF EXISTS `sczd_gjhhr_day_achievements_log`;
CREATE TABLE `sczd_gjhhr_day_achievements_log`  (
  `no` int(11) NULL DEFAULT NULL,
  `id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `group_achievements` bigint(20) NULL DEFAULT NULL,
  `all_achievements` bigint(20) NULL DEFAULT NULL,
  `tuikuan` bigint(20) NULL DEFAULT NULL,
  `achievements_show` bigint(20) NULL DEFAULT NULL
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `statistics_system_realtime`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `time`(`time`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 77101 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '实时统计数据' ROW_FORMAT = Dynamic;
