...
shoping_api_server = "http://mall-server-user.jyhd919.cn"
...
local services = 
{
	...
	{	-- 登录
		...
		deploy = {login_service="gate"},
	},
	{	-- 验证
		launch = "verify_service/verify_service",
		deploy = {verify_service="gate"},
	},
	{	-- 房卡场
	...
	{	-- web 服务
		...
		deploy = {web_server_service="gate"},
	},
	{	-- 服务管理
		launch = "admin_console_service/admin_console_service",
		deploy = {service_console="gate"},
	},
	{	-- 游戏管理
	...
	{	-- 第三方服务代理，如 短信、分享
		...
		deploy = {third_agent_service="gate"},
	},
