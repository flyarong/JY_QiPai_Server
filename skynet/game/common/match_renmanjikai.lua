...
function PROTECTED.check_signup_situation()
	--达到开赛条件
	if DATA.signup_players_count==DATA.match_services[DATA.signup_match_my_id].begin_game_condi then
...
function PROTECTED.start_sigup()
	...
	if (DATA.complete_match>=DATA.match_config.signup_data_config.max_round and DATA.match_config.signup_data_config.max_round~=-1)
