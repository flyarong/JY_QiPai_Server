...
local laji_pai_create = {
	[1] = {
		...
		[1] = { pai_type = PAI_TYPE.boom  , min_num = 0, max_num = 1 , min_pai = 3 , max_pai = 15, gailv_type = GAILV_TYPE.random },
		[2] = { pai_type = PAI_TYPE.danpai  , min_num = 0, max_num = 0 , min_pai = 3 , max_pai = 17, gailv_type = GAILV_TYPE.fix_all },
	},
	[2] = {
		[1] = { pai_type = PAI_TYPE.boom  , min_num = 0, max_num = 2 , min_pai = 3 , max_pai = 15, gailv_type = GAILV_TYPE.random },
		[2] = { pai_type = PAI_TYPE.danpai  , min_num = 0, max_num = 0 , min_pai = 3 , max_pai = 17, gailv_type = GAILV_TYPE.fix_all },
	},
	[3] = {
	...
	[5] = {
		[1] = { pai_type = PAI_TYPE.boom  , min_num = 1, max_num = 3 , min_pai = 3 , max_pai = 13, gailv_type = GAILV_TYPE.random },
