...
local function init_data()
	player_withdraw_cash_data = skynet.call(DATA.service_config.data_service,"lua","query_all_gjhhr_withdraw_status")
end
...
function CMD.query_player_withdraw_cash_gjhhr_status(_player_id,_money)
...
function CMD.player_withdraw_cash_gjhhr(_player_id,_money)
	...
	if ret.status == 0 then
		...
		skynet.send(DATA.service_config.data_service,"lua","update_gjhhr_withdraw_status",_player_id,pwcd)
	end
...
function CMD.set_withdraw_cash_gjhhr_cfg(_min_withdraw_limit,_everyday_withdraw_max_limit,_everyday_withdraw_num,_system_everyday_withdraw_max_limit)
...
function PROTECT.init()
	...
	nodefunc.query_global_config("withdraw_cash_gjhhr_config",load_cfg)
