...
function PROTECT.init_config_info()
	...
	--local raw_freestyle_configs = require "tyddz_freestyle_server"
	local raw_freestyle_configs = base.reload_config("tyddz_freestyle_server")
...
function PROTECT.reload_config_info()
	--package.loaded["tyddz_freestyle_server"] = nil
