...
local config_module = require "normal_mjxl_freestyle_center_service.normal_mjxl_freestyle_config_module"
...
local function create_service_id()
	...
	return "normal_mjxl_freestyle_service_" .. service_count
end
...
function CMD.start(_service_config)
	...
	nodefunc.register_game("mjxl_freestyle_game")
